...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lot.has_vacant_building'
        db.add_column(u'philadelphia_lot', 'has_vacant_building',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lot.has_vacant_building'
        db.delete_column(u'philadelphia_lot', 'has_vacant_building')
