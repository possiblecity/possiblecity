...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Lot', fields ['address', 'city', 'state']
        db.create_unique(u'lotxlot_lot', ['address', 'city', 'state'])


    def backwards(self, orm):
        # Removing unique constraint on 'Lot', fields ['address', 'city', 'state']
        db.delete_unique(u'lotxlot_lot', ['address', 'city', 'state'])
