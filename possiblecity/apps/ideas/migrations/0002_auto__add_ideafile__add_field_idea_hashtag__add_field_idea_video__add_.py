...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IdeaFile'
        db.create_table(u'ideas_ideafile', (
        ...
        db.send_create_signal(u'ideas', ['IdeaFile'])

        # Adding field 'Idea.hashtag'
        db.add_column(u'ideas_idea', 'hashtag',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True),
                      keep_default=False)

        # Adding field 'Idea.video'
        db.add_column(u'ideas_idea', 'video',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Idea.website'
        db.add_column(u'ideas_idea', 'website',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'IdeaFile'
        db.delete_table(u'ideas_ideafile')

        # Deleting field 'Idea.hashtag'
        db.delete_column(u'ideas_idea', 'hashtag')

        # Deleting field 'Idea.video'
        db.delete_column(u'ideas_idea', 'video')

        # Deleting field 'Idea.website'
        db.delete_column(u'ideas_idea', 'website')
