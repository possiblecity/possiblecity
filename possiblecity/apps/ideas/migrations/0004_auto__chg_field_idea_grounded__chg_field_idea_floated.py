...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Idea.grounded'
        db.alter_column(u'ideas_idea', 'grounded', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Idea.floated'
        db.alter_column(u'ideas_idea', 'floated', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Idea.grounded'
        db.alter_column(u'ideas_idea', 'grounded', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Idea.floated'
        db.alter_column(u'ideas_idea', 'floated', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        u'ideas.idea': {
            ...
            'hashtag': ('django.db.models.fields.CharField', [], {'max_length': '40', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
