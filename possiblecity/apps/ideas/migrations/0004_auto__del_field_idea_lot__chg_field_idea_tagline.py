...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Idea.lot'
        db.delete_column(u'ideas_idea', 'lot_id')

        # Adding M2M table for field lot on 'Idea'
        m2m_table_name = db.shorten_name(u'ideas_idea_lot')
        ...
        # Changing field 'Idea.tagline'
        db.alter_column(u'ideas_idea', 'tagline', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Adding field 'Idea.lot'
        db.add_column(u'ideas_idea', 'lot',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lotxlot.Lot'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field lot on 'Idea'
        db.delete_table(db.shorten_name(u'ideas_idea_lot'))


        # Changing field 'Idea.tagline'
        db.alter_column(u'ideas_idea', 'tagline', self.gf('django.db.models.fields.CharField')(max_length=140))
    ...
    models = {
        ...
        u'ideas.idea': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lot': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['lotxlot.Lot']", 'null': 'True', 'blank': 'True'}),
