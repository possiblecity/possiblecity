...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'ideas_idea', 'modified')

        # Adding field 'Idea.updated'
        db.add_column(u'ideas_idea', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 9, 2, 0, 0), blank=True),
                      keep_default=False)


        # Changing field 'Idea.created'
        db.alter_column(u'ideas_idea', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Idea.modified'
        raise RuntimeError("Cannot reverse this migration. 'Idea.modified' and its values cannot be restored.")
        # Deleting field 'Idea.updated'
        db.delete_column(u'ideas_idea', 'updated')


        # Changing field 'Idea.created'
        db.alter_column(u'ideas_idea', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
