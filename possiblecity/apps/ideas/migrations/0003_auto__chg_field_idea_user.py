...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Idea.user'
        db.alter_column(u'ideas_idea', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Idea.user'
        raise RuntimeError("Cannot reverse this migration. 'Idea.user' and its values cannot be restored.")
    ...
    models = {
        ...
        u'ideas.idea': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lot': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lotxlot.Lot']", 'null': 'True', 'blank': 'True'}),
