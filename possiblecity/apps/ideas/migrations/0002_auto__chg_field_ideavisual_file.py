...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IdeaVisual.file'
        db.alter_column(u'ideas_ideavisual', 'file', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'IdeaVisual.file'
        db.alter_column(u'ideas_ideavisual', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
