...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Entry'
        db.create_table('text_entry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('excerpt', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('status', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=4)),
        ...
        db.send_create_signal('text', ['Entry'])

        # Adding model 'EntryImage'
        db.create_table('text_entryimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('entry', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['text.Entry'], null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('text', ['EntryImage'])


    def backwards(self, orm):
        # Deleting model 'Entry'
        db.delete_table('text_entry')

        # Deleting model 'EntryImage'
        db.delete_table('text_entryimage')
